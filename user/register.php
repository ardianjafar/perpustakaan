                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="cek_register.php">
                                        <div class="form-group">
                                            <input type="text" name="name" class="form-control form-control-user" placeholder="Masukkan Nama">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="alamat" class="form-control form-control-user" placeholder="Masukkan No Alamat">
                                        </div>
                                        <div class="text-center">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <h4>
                                                <a class="btn btn-warning btn-user btn-block " href="login.php">Login</a>
                                            </h4>
                                        </div>
                                    </form>
